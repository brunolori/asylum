...
@ManagedBean
@ViewScoped
public class DfacTransferRejectedBean implements Serializable {
	...
	public void load()
	{
		...
		req = new TransferSx();
		req.setTransferStatusId(ITransferStatus.REJECTED);
		this.transfers = new TransferService().searchTransfer(req);
		
		if(transfers == null || transfers.isEmpty())
		{
			Messages.throwFacesMessage("Nuk ka transferime ne proces",2);
		}
